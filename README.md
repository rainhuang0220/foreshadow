...
**Beta 0.5.1** — find what the future has already foreshadowed. Then prepare a local contribution.
...
# or: uv tool uninstall foreshadow-radar && uv tool install "git+https://github.com/rainhuang0220/foreshadow.git@v0.5.1"
```
